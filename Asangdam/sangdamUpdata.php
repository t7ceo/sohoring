...
include 'util.php';
	...
	//상담센터 입주
	$rr = mysql_query("insert into Anyting_company (companyid, project, gubun, masterid, sangho, coname, memo, tel, juso, url, indon, indate) values('".$company_id."', '".$project."', ".$gubun.", '".$memid."', '".$sangho."', '".$coname."', '".$memo."', '".$tel."', '".$addr."', '".$url."', ".$indongab.", '".$ad_date."')",$rs);
