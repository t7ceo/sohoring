...
include 'util.php';
	...
	//가맹점 수정
	$rr = mysql_query("update Anyting_company set sangho = '$sangho', coname = '$coname', project = '$project', memo = '$memo', tel = '$tel', jygab = $mgubun, gubun = $gubun, juso = '$addr', url = '$url' where companyid = '$comid' limit 1",$rs);
	if(!$rr){
